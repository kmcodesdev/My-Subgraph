...
export class ss__transactionsResult {
  value0: Address;
  value1: BigInt;
  value2: Bytes;
  value3: boolean;
...
export class ss extends ethereum.SmartContract {
  static bind(address: Address): ss {
    return new ss("ss", address);
  }
  ...
  transactions(param0: BigInt): ss__transactionsResult {
    let result = super.call(
      "transactions",
    ...
    return new ss__transactionsResult(
      result[0].toAddress(),
      result[1].toBigInt(),
      result[2].toBytes(),
      result[3].toBoolean()
  ...
  try_transactions(
    param0: BigInt
  ): ethereum.CallResult<ss__transactionsResult> {
    let result = super.tryCall(
      "transactions",
      "transactions(uint256):(address,uint256,bytes,bool)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
